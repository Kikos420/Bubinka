...
public:
    ...
    SparePart(string id1, string name1, string description1, Vehicle v, double price1, condition c, float replacementtime1, float replacementwage1, string instructions1) {
        id = id1;
        name = name1;
...
public:
    ...
    //constructor
    AvailableSparePart(int w, string r, string id1, string name1, string description1, Vehicle v, double price1, condition c, float replacementtime1, float replacementwage1, string instructions1) : SparePart(id1, name1, description1, v, price1, c, replacementtime1, replacementwage1, instructions1)
    {
        quantity = w;
        location = r;
    }
...
public:
    ...
    //constructor
    ContractedSparePart(string vendor1, double dp, int dt, string id1, string name1, string description1, Vehicle v, double price1, condition c, float replacementtime1, float replacementwage1, string instructions1) : SparePart(id1, name1, description1, v, price1, c, replacementtime1, replacementwage1, instructions1)
    {
        vendor = vendor1;
        deliveryPrice = dp;
        deliveryTime = dt;
...
int main() { //Main function of driver
    ...
    for (int i = 0; i < Parts.size(); i++) {
        cout << Parts[i]->getName() << " for the price of: $" << Parts[i]->getTotalPrice() << endl;
    }
    return 0;
}
